...
public class OphthalmologyOVTest extends iTrustSeleniumTest{
	...
	public void testCreateOphthalmologyOfficeVisit() throws Exception{
		...
		new Select(driver.findElement(By.name("apptType"))).selectByValue("Ophthalmology");
		...
		driver.findElement(By.xpath(".//*[@value='Add Ophthalmology Data']")).submit();
	...
	public void testCreateWithErrorChecking() throws Exception{
		...
		assertTrue(driver.getPageSource().contains("OSSphere: Must be a double between -10 and 10"));
	...
	/**
	 * Tests having an non-opthamologist hcp trying to edit a opthamology office visit
	 * @throws Exception
	 */
	...
	public void testMissingOphthalmologistData() throws Exception{
		...
		assertTrue(driver.getPageSource().contains("Acuity: Must be a positive integer."));
		assertTrue(driver.getPageSource().contains("Acuity: Must be a positive integer."));
		assertTrue(driver.getPageSource().contains("ODSphere: Must be a double between -10 and 10"));
		assertTrue(driver.getPageSource().contains("OSSphere: Must be a double between -10 and 10"));
		assertTrue(driver.getPageSource().contains("ODAdd: Must be between .75 and 3.00"));
		assertTrue(driver.getPageSource().contains("OSAdd: Must be between .75 and 3.00"));
	}
	...
	public void testEditOfficeVisit_DeleteData() throws Exception{
		...
		//Submit form
		driver.findElement(By.xpath(".//*[@value='Update Ophthalmology Data']")).click();
		driver.findElement(By.xpath(".//*[@value='Update Ophthalmology Data']")).submit();
	...
	public void testNoDependents() throws Exception{
		...
		assertTrue(driver.getPageSource().contains("Freya is not representing any patients"));
