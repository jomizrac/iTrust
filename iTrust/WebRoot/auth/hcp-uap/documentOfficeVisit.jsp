...
<div align=center>
	<form action="documentOfficeVisit.jsp" method="post" id="formMain">
		...
		<input type="hidden" name="formIsFilled" value="true" /> <br /> <br />		Are you sure you want to document a <em>new</em> visit for <b><%=StringEscapeUtils.escapeHtml("" + (action.getUserName()))%></b>?<br />
