...
public class ViewOfficeVisitAction extends OfficeVisitBaseAction {
	...
	private OphthalmologyDataDAO ophthalmologyDAO;
	...
	public ViewOfficeVisitAction(DAOFactory factory, long loggedInMID, String ovIDString)
		...
		ophthalmologyDAO = factory.getOphthalmologyDataDAO();
	...
	public List<OphthalmologyDataBean> getOphthalmology() throws DBException {
		return ophthalmologyDAO.getList(ovID);
	}
