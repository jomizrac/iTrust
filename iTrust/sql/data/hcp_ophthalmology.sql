...
INSERT INTO users(MID, password, role, sQuestion, sAnswer) VALUES(9900000022, '30c952fab122c3f9759f02a6d95c3758b246b4fee239957b2d4fee46e26170c4', 'hcp', 'second letter?', 'w')
ON DUPLICATE KEY UPDATE mid = mid;
/*password: pw*/
