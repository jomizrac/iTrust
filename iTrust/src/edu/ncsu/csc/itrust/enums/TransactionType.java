...
public enum TransactionType {
	...
	/**Created an Ophthalmology Office Visit**/
	CREATE_OPHTHALMOLOGY_OFFICE_VISIT(8300, "Create Ophthalmology Office Visit", "created an Ophthalmology office visit", true),
