...
<%
	...
	<%
		//list of all hospitals the expert is assigned to 
	...
	<div class="modal-footer">
   	<button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
					...
					//closest distance between hospital and patient 
					int distance = -1;
					//distance between the current hospital and the patient
					int currDistance = 0;
					//find the distance between the closest hospital and the patient
					for(HospitalBean hospital : hospitals) {

						currDistance = zipCodeAction.calcDistance(hospital.getHospitalZip(), zipCode);
						if (distance == -1) {
					...
					if (distance == Integer.MAX_VALUE){
						distanceFromYou = "No Information";
					} else {
						distanceFromYou = Integer.toString(distance);
					}
					...
					{ 
						...
						%>
							<div class="grey-border-container">
								...
								<% if (distance == Integer.MAX_VALUE) { %>
									<p><b>Distance From You:</b> <%= StringEscapeUtils.escapeHtml(distanceFromYou) %></p>
								<% } else { %>						
