...
public class ActivityFeedTest extends iTrustSeleniumTest {
	...
	public void testDLHCPActivityHiddenInFeed1() throws Exception {
		...
		//Get the list items and count how many items there are, should be 16
		List<WebElement> listItems = activityPanel.findElements(By.tagName("li"));
		assertEquals(16, listItems.size());
		...
		for (int i = 0; i < listItems.size(); i++) {
			assertFalse(listItems.get(i).getText().contains("Kelly Doctor viewed your prescription report"));
			assertFalse(listItems.get(i).getText().contains("Kelly Doctor edited your demographics"));
		}
