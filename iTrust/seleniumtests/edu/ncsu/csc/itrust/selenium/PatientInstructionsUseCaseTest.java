...
public class PatientInstructionsUseCaseTest extends iTrustSeleniumTest {
	...
	*/
	...
	/*
	 * Tests what happens when there is leading or trailing whitespace.
	 */
	@Test
	public void testWhiteSpaceUseCase() throws Exception {
		gen.hcp4();
		...
		// Add instructions with whitespace after the URL
		WebElement form = driver.findElement(By.id("patientInstructionsForm"));
		form.findElement(By.name("name")).sendKeys("Test Trailing Space");
		form.findElement(By.name("url")).sendKeys("http://www.webmd.com/cold-and-flu/flu-guide/what-to-eat-when-you-have-the-flu ");
		form.findElement(By.name("comment")).sendKeys("Try to add this URL.");
		form.submit();
		form.submit();
		...
		WebElement tbl = driver.findElement(By.id("patientInstructionsTable"));
		assertTrue(tbl.findElements(By.tagName("tr")).get(2).getText().contains("Test Trailing Space"));
	}
