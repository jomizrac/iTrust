...
%>
	...
	<%OphthalmologyDataDAO ophthalmology = prodDAO.getOphthalmologyDataDAO();
	for(OphthalmologyDataBean odbean : ovaction.getOphthalmology()){
    	...
    	<td align=center><%= StringEscapeUtils.escapeHtml("" + (decimalFormat.format(odbean.getOSCylinder()))) %></td>
    	...
    	<td align=center><%= StringEscapeUtils.escapeHtml("" + (decimalFormat.format(odbean.getODAdd()))) %></td>
    	<td align=center><%= StringEscapeUtils.escapeHtml("" + (decimalFormat.format(odbean.getOSAdd()))) %></td>
		<%
	}
