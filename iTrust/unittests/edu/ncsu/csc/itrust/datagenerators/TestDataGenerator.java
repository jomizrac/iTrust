...
public class TestDataGenerator {
	...
	public void standardData() throws FileNotFoundException, IOException,
		...
		/* New for Ophthalmology */
		hcpOphthalmology();
		patient72();
		patient15_ophthalmology();
		ovOphthalmology();
		ovOphthalmologyData();
	...
	public void hcpOphthalmology() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/hcp_ophthalmology.sql");
	}

	public void patient72() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient72_ophthalmology.sql");
	}

	public void patient15_ophthalmology() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient15_ophthalmology.sql");
	}

	public void ovOphthalmology() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/ovOphthalmology.sql");
	}

	public void ovOphthalmologyData() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/ovOphthalmologyData.sql");
	}
	
	public void uc84() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/uc84.sql");
	}
	
	public void brody_franco_ov() throws SQLException, FileNotFoundException, IOException{
